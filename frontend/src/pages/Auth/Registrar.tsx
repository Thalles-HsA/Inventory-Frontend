        ...
        {({ values, setFieldValue, errors, setFieldTouched }) => (
          <Form className="form-cadastro">
            ...
            >
              ...
              <span className="obrigatorio">(*) Campos obrigatórios</span>

              <label>
                {valid && errors.email && <ErrorMessage name="email" component="span" className="message-error" />}
                <Field type="email" placeholder='E-mail*' name="email" innerRef={inputRef} onFocus={() => setValid(false)} />
              </label>

              <label>
                {valid && errors.senha && <ErrorMessage name="senha" component="span" className="message-error" />}
                <Field type="password" placeholder='Senha*' name="senha" onFocus={() => setValid(false)} />
              </label>

              <label>
                {valid && errors.confirmarSenha && <ErrorMessage name="confirmarSenha" component="span" className="message-error" />}
                <Field type="password" placeholder='Confirme sua senha*' name="confirmarSenha" onFocus={() => setValid(false)} />
              </label>
            ...
            >
              ...
              <label>
                <Field
                  type="radio" name="tipo" value="cpf"
                  onClick={() => {
            ...
            >
              ...
              <label>
                ...
                <Field type="text" placeholder='Logradouro*' name="logradouro" onFocus={() => setValid(false)} />
              </label>

              <label>
                {valid && errors.numero && <ErrorMessage name="numero" component="span" className="message-error" />}
                <Field className="input-menor" type="text" placeholder='Número*' name="numero" onFocus={() => setValid(false)} />
              </label>

              <label>
                {valid && errors.complemento && <ErrorMessage name="complemento" component="span" className="message-error" />}
                <Field className="input-medio" type="text" placeholder='Complemento' name="complemento" onFocus={() => setValid(false)} />
              </label>

              <label>
                {valid && errors.bairro && <ErrorMessage name="bairro" component="span" className="message-error" />}
                <Field type="text" placeholder='Bairro*' name="bairro" onFocus={() => setValid(false)} />
              </label>

              <label>
                {valid && errors.cidade && <ErrorMessage name="cidade" component="span" className="message-error" />}
                <Field type="text" placeholder='Cidade*' name="cidade" onFocus={() => setValid(false)} />
              </label>

              <label>
                {valid && errors.estado && <ErrorMessage name="estado" component="span" className="message-error" />}
                <Field className="input-menor" type="text" placeholder='UF*' name="estado" onFocus={() => setValid(false)} />
              </label>

              <label>
                {valid && errors.cep && <ErrorMessage name="cep" component="span" className="message-error" />}
                <Field className="input-medio" type="text" placeholder='CEP*' name="cep" onFocus={() => setValid(false)} />
              </label>
